...
[MSE_test,MSE_test1,Var_test,Var_test1] = GPR_ROM_Interpolation(p_pool,@NS_snapshots_test,Mu_t,Var_t,U_r,x_train);
...
for i = 1:5
    ...
    [MSE_test,MSE_test1, Var_test] = GPR_ROM_Interpolation(p_pool,@NS_snapshots_test,Mu_t,Var_t,U_r,x_train);
...
% 
% subplot(1,2,1)
% plot(1:length(p_pool),MSE_test,'-','LineWidth',1.5);
% ylabel('AMRE');
% xlabel('Iterations');
% 
% subplot(1,2,2)
% plot(1:length(p_pool),Var_test,'-','LineWidth',1.5);
% ylabel('AMRStd');
% xlabel('Iterations');
...
tic
[Mu_full,Var_full,X_full] = GPR_ROM_prediction(x_test,@NS_snapshots_test,Mu_t,Var_t,U_r,x_train);
toc
