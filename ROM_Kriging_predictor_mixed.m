function [X_mean,X_Var] = ROM_Kriging_predictor_mixed(Xtest,Kriging_Model,m)
...
for j = 1:m
     ...
     for i = 1: r
        [Mean(j,i), Var(j,i)] = Kriging_predictor_mixed(u_test(j,:),Kriging_Model{i}); % assign same weight for each component of y_r
     end
